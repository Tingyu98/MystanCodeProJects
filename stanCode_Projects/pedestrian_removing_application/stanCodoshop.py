...
def get_average(pixels):
    ...
    rgb = [red_sum//n, green_sum//n, blue_sum//n]
    return rgb
...
def get_best_pixel(pixels):
    ...
    pixel_lst = ([pixel, get_pixel_dist(pixel, avg_rgb[0], avg_rgb[1], avg_rgb[2])] for pixel in pixels)
...
def main():
    """
    remover passersby from the picture
    """
    # (provided, DO NOT MODIFY)
    args = sys.argv[1:]
